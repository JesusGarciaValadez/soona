...
{if $page_name == 'index' || $page_name == 'category' || $page_name == 'product' || $page_name == 'order' || $page_name == 'order-opc'}<script type="text/javascript" src="{$js_dir}megnor/carousel.min.js"></script>{/if}
