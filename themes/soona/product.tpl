...
{include file="$tpl_dir./breadcrumb.tpl"}
                        <div id="primary_block" class="clearfix{if $product} product{/if}">
                            ...
                            <div id="pb-right-column"><!-- right infos-->
                                ...
                                <div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}"><!-- thumbnails -->
                                    ...
                                    <ul id="thumbs_list_frame">
                                        ...
                                        <li id="thumbnail_{$image.id_image}">
                                            <a href="{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html'}" class="trip" title="{$imageTitlte}">
 ...
 $(document).ready(function(){
 	$('#thumbs_list_frame .trip').lightBox();
 });
</script>
{/literal}
                                ...
                                <p class="resetimg clear">
                                    <span id="wrapResetImages" style="display: none;"><!--<img src="{$img_dir}icon/cancel_11x13.gif" alt="{l s='Cancel'}" width="11" height="13"/> -->
                                        <a id="resetImages" href="{$link->getProductLink($product)|escape:'html'}" onclick="$('span#wrapResetImages').hide('slow');return (false);">{l s='Display all pictures'}</a>
                                    </span>
                                </p>
                                {/if}
                              ...
                              <div id="block_icons">
                               <ul>
                                <li><img src="{$img_dir}soona_img/iconos/amor.png" /></li>
                                <li><img src="{$img_dir}soona_img/iconos/compromiso.png" /></li>
                                <li><img src="{$img_dir}soona_img/iconos/corporativo.png" /></li>
                               </ul>
                              </div>   
                            </div><!-- right infos-->
                            <div id="pb-left-column"><!-- left infos-->
                                ...
                                <!-- add to cart form-->
                                <form id="buy_block" name="product_form" {if $PS_CATALOG_MODE AND !isset($groups) AND $product->quantity > 0}class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html'}" method="post">
                                    <p class="hidden">
                                    ...
                                    <div class="product_attributes">
                                        ...
                                        <p id="availability_statut"{if ($product->quantity <= 0 && !$product->available_later && $allow_oosp) OR ($product->quantity > 0 && !$product->available_now) OR !$product->available_for_order OR $PS_CATALOG_MODE} style="display: none;"{/if}><!-- availability -->
                                    ...
                                    <div class="content_prices"><!-- prices -->
                                        ...
                                        <div class="offers_box"><!-- Offer Box-->
                                            ...
                                            <span class="on_sale"><span class="on_sale_inner">{l s='On sale!'}</span></span>
                                            {elseif $product->specificPrice AND $product->specificPrice.reduction AND $productPriceWithoutReduction > $productPrice}
                                            <span class="discount"><span class="on_sale_inner">{l s='Reduced price!'}</span></span>
                                            {/if}
                                            {if $priceDisplay == 2}
                                            <br />
                                        ...
                                        {else}
                                            <p id="add_to_cart" class="buttons_bottom_block">
                                                ...
                                                <a class="style_cart" onclick="document.product_form.submit();" name="Submit">&nbsp;</a>
                                                <a class="style_sale" href="index.php?controller=cart">&nbsp;</a>
                                            </p>
                                        {/if}<!-- Add to cart -->
                                        ...
                                        <p id="minimal_quantity_wanted_p"{if $product->minimal_quantity <= 1 OR !$product->available_for_order OR $PS_CATALOG_MODE} style="display: none;"{/if}>
                                                {l s='This product is not sold individually. You must select at least'} <strong id="minimal_quantity_label">{$product->minimal_quantity}</strong> {l s='quantity for this product.'}
                                        </p>
                                        ...
                                        <li class="ajax_block_product  {if $productCount >= $sliderFor}slider-item{/if}{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
                                            <div class="product-block">
                                                <div class="product-inner">
                                                    ...
                                                    <a href="{$accessoryLink|escape:'htmlall':'UTF-8'}" title="{$accessory.legend|escape:'htmlall':'UTF-8'}" class="product_image" style="height:{$val}px"><img src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'home_default')|escape:'html'}" alt="{$accessory.legend|escape:'htmlall':'UTF-8'}" width="{$homeSize.width}" height="{$homeSize.height}" /></a>
                                                    ...
                                                    <p class="price_container"> <span class="price">{if $priceDisplay != 1}{displayWtPrice p=$accessory.price}{else}{displayWtPrice p=$accessory.price_tax_exc}{/if}</span></p>
                                                    {/if}
