...
{if isset($category)}
    {if $category->id AND $category->active}
        ...
        <div id="sello_catalogo">
            <img src="{$img_dir}soona_img/images_soona/sello_catalogo.png"/>
        </div>
        <div id="soona_icons">
            <ul>
                <li class="hint--bottom" data-hint="Amistad"><img src="{$img_dir}soona_img/iconos/amistad.png" class="img" /></li>
                <li class="hint--bottom" data-hint="Amor"><img src="{$img_dir}soona_img/iconos/amor.png" class="img" /></li>
