...
<div id="cart_block" class="block exclusive">
    ...
    {/if}
        ...
        <p id="cart-buttons">
            ...
            <a href="{$link->getPageLink("$order_process", true)|escape:'html'}" class="button_small" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">{l s='Cart' mod='blockcart'}</a>
            {/if}
