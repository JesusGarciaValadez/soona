...
<div id="search_block_top">
    <form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox" class="clearfix">
        <p>
...
{if $logged}
    <a href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Ir a mi Cuenta' mod='blockuserinfo'}" class="account view_account" rel="nofollow">
        <span class="crown"></span>
        <span>{l s='Bienvenido(a)' mod='blockuserinfo'} {$cookie->customer_firstname}</span>
        <span class="crown"></span>
    </a>
{/if}
</div>
