<?php /* Smarty version Smarty-3.1.14, created on 2014-04-11 14:15:10
         compiled from "/Applications/MAMP/htdocs/soona/themes/soona/modules/homefeatured/homefeatured.tpl" */ ?>
<?php /*%%SmartyHeaderCode:104814982653483f3e586557-13374383%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1275eb6e6fe4b4cd404ed3ad61efa88fbc6b107b' => 
    array (
      0 => '/Applications/MAMP/htdocs/soona/themes/soona/modules/homefeatured/homefeatured.tpl',
      1 => 1397145065,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '104814982653483f3e586557-13374383',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53483f3e9b0e46_04889531',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53483f3e9b0e46_04889531')) {function content_53483f3e9b0e46_04889531($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/soona/tools/smarty/plugins/modifier.escape.php';
?>
...
corporativo/11-suscripcion.html" title="Haz tus pedidos" target="_self">Haz tus pedidos</a>
                        ...
                        <div id="featured_products_wrapper">
                            ...
                            <div class="block_content">
                                <!-- Megnor start -->
                                <?php $_smarty_tpl->tpl_vars['sliderFor'] = new Smarty_variable(11, null, 0);?> <!-- Define Number of product for SLIDER -->
...
?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['product']->index==3){?>
                                        <?php break 1?>
                                    <?php }?>
...
soona_img/images_soona/banner_entrega.jpg" alt="Entrega a Domicilio" width="669" height="103" />
                        <section id="catalog_home">
                            ...
                            <ul class="catalog_list">
                                ...
                                <?php $_smarty_tpl->tpl_vars['foo'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['foo']->step = 3;$_smarty_tpl->tpl_vars['foo']->total = (int)ceil(($_smarty_tpl->tpl_vars['foo']->step > 0 ? 9+1 - (0) : 0-(9)+1)/abs($_smarty_tpl->tpl_vars['foo']->step));
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration == 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration == $_smarty_tpl->tpl_vars['foo']->total;?>
                                <li>
                                    <article>
                                        <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['link_rewrite'],$_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['id_image'],'catalog_soona'), ENT_QUOTES, 'UTF-8', true);?>
" width="<?php echo $_smarty_tpl->tpl_vars['catalogSize']->value['width'];?>
" height="<?php echo $_smarty_tpl->tpl_vars['catalogSize']->value['height'];?>
" alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['name'], 'htmlall', 'UTF-8');?>
" />
                                        <div class="product_information_wrapper">
                                            <div class="product_information left">
                                                <?php if ($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['name']&&!empty($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['name'])){?>
                                                <p class="product_name_catalog"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['name'],12,'...'), 'htmlall', 'UTF-8');?>
</p>
                                                <?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['show_price']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
                                                <p class="product_price_catalog">
                                                    <?php if (!$_smarty_tpl->tpl_vars['priceDisplay']->value){?>
                                                    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['price']),$_smarty_tpl);?>

                                                    <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['price_tax_exc']),$_smarty_tpl);?>
...
?qty=1&amp;id_product=<?php echo $_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['id_product'];?>
&amp;token=<?php echo $_smarty_tpl->tpl_vars['static_token']->value;?>
...
" target="_self">Agregar al Carrito</a>
                                            ...
                                            <hr />
                                            <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['products']->value[$_smarty_tpl->tpl_vars['foo']->value]['link'], ENT_QUOTES, 'UTF-8', true);?>
